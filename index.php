...
<div class="container" id="nav_container">
	...
	<div class="row" id="nav_row">
        	...
        	<img class="span3 thumbnail nav_item nav_item_first" id="nav_corp" src="http://dummyimage.com/350x175" />
          
        	<img class="span3 thumbnail nav_item" id="nav_residential" src="http://dummyimage.com/350x175" />
        
        	<img class="span3  thumbnail nav_item nav_item_last" id="nav_brockerage" src="http://dummyimage.com/350x175" />
