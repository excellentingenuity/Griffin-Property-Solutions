...
<div class="container" id="nav_container">
	...
	<div class="row static-content-main-nav">
        	...
        	<img class="span3 nav_item nav_item_first" id="nav_corp" src="http://placehold.it/350x175" />
          
        	<img class="span3 nav_item" id="nav_residential" src="http://placehold.it/350x175" />
        	
        	<img class="span3 nav_item" id="nav_consulting" src="http://placehold.it/350x175" />
        
        	<img class="span3 nav_item nav_item_last" id="nav_brockerage" src="http://placehold.it/350x175" />
